...
class adder_drv extends uvm_driver#(adder_seq_item);
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if(!uvm_config_db#(virtual adder_interface)::get(this, "", "adder_if", adder_if)) begin
...
class adder_mon extends uvm_monitor;
    ...
    virtual task run_phase(uvm_phase phase);
        forever begin
            #10;
            a_seq_item = adder_seq_item::type_id::create("MON_ITEM");
...
module tb_adder();
    ...
    initial begin
        uvm_config_db#(virtual adder_interface)::set(null, "*", "adder_if",adder_if);
        run_test("adder_test");
    end
endmodule
