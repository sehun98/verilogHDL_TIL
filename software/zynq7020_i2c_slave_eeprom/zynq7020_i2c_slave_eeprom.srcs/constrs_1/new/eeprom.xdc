...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { chip_select[0] }]; #IO_L24P_T3_34 Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { chip_select[1] }]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { chip_select[2] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { sda }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { scl }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
